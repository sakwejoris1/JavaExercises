...
public class FileMatch_15_4 {
    public static void main(String[] args) {
        List<Account_15_4> masterAccounts = new ArrayList<>();
        List<TransactionRecord_15_4> transactions = new ArrayList<>();
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader("oldmast.txt"))) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                masterAccounts.add(new Account_15_4(accountNumber, name, balance));
            }
        } catch (IOException e) {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader("trans.txt"))) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                transactions.add(new TransactionRecord_15_4(accountNumber, amount));
            }
        } catch (IOException e) {
        ...
        try (PrintWriter newMaster = new PrintWriter(new FileWriter("newmast.txt"));
            ...
            for (Account_15_4 account : masterAccounts) {
                for (int i = 0; i < transactions.size(); i++) {
                    TransactionRecord_15_4 t = transactions.get(i);
